                                ...
                                <form class="form-inline" required>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                        	<label class="form-control-label" for="tip">Tipo de documento</label>
                                   ...
                                   <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="Nombres" id="nams" required>
                                            <label class="form-control-label" for="lnam">Apellidos</label>
                                            <input class="form-control" type="text" placeholder="Apellidos" id="lnam" required>
                                        </div>
                                    </div>
                                    <button class="btn btn-primary w-100" style="margin-top: 4%;">Consultar cliente</button>
                                </form>
                            </div>
                        </div>
                    </div>
